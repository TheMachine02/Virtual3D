...
tools/mdlconv.exe example/file/CavesOfKaliyaTRIII.obj -T -N -S -B -X -F -o=KALIYA

fasmg example/file/CavesOfKaliyaTRIII0.inc bin/KALIYAV.8xv
fasmg example/file/CavesOfKaliyaTRIII1.inc bin/KALIYAF.8xv

tools/mdlconv.exeexample/file/CityTRIII.obj -T -N -S -B -X -F -o=CITY
fasmg example/file/CityTRIII0.inc bin/CITYV.8xv
fasmg example/file/CityTRIII1.inc bin/CITYF.8xv

tools/mdlconv.exe example/file/TrainRoomTRIII.obj -T -N -S -B -X -F -o=TRAIN
fasmg example/file/TrainRoomTRIII0.inc bin/TRAINV.8xv
fasmg example/file/TrainRoomTRIII1.inc bin/TRAINF.8xv

tools/mdlconv.exe example/file/PoolTRIII.obj -T -N -S -B -X -F -o=POOL
fasmg example/file/PoolTRIII0.inc bin/POOLV.8xv
fasmg example/file/PoolTRIII1.inc bin/POOLF.8xv

Rem tools/mdlconv.exe example/file/room_commune.obj -T -N -S -B -X -o=ROOM
Rem fasmg example/file/room_commune0.inc bin/ROOMV.8xv
Rem fasmg example/file/room_commune1.inc bin/ROOMF.8xv

echo "Converting Suzanne..."

tools/mdlconv.exe example/file/Suzanne.obj -C -N -S -B -X -F -o=SUZAN
...
Rem tools/mdlconv.exe example/file/MateusFFXII.obj -T -N -S -B -X -o=MATEUS
Rem fasmg example/file/MateusFFXII0.inc bin/MATEUSV.8xv 
Rem fasmg example/file/MateusFFXII1.inc bin/MATEUSF.8xv 

tools/mdlconv.exe example/file/BunnyFFXII.obj -T -N -S -B -X -F -o=FLUFFY
fasmg example/file/BunnyFFXII0.inc bin/FLUFFYV.8xv
fasmg example/file/BunnyFFXII1.inc bin/FLUFFYF.8xv

tools/mdlconv.exe example/file/FranFFXII.obj -T -N -S -B -X -F -o=FRAN
fasmg example/file/FranFFXII0.inc bin/FRANV.8xv
fasmg example/file/FranFFXII1.inc bin/FRANF.8xv

tools/mdlconv.exe example/file/MjrnFFXII.obj -T -N -S -B -X -F -o=MJRN
fasmg example/file/MjrnFFXII0.inc bin/MJRNV.8xv
fasmg example/file/MjrnFFXII1.inc bin/MJRNF.8xv

tools/mdlconv.exe example/file/FranFFXII_LOD1.obj -T -N -S -B -X -F -o=FRANL
fasmg example/file/FranFFXII_LOD10.inc bin/FRANLV.8xv
fasmg example/file/FranFFXII_LOD11.inc bin/FRANLF.8xv

tools/mdlconv.exe example/file/VieraSceneFFXII.obj -T -N -S -B -X -F -o=VIERA
fasmg example/file/VieraSceneFFXII0.inc bin/VIERAV.8xv
fasmg example/file/VieraSceneFFXII1.inc bin/VIERAF.8xv

tools/mdlconv.exe example/file/BomboFFXII.obj -T -N -S -B -X -F -o=BOMBO
fasmg example/file/BomboFFXII0.inc bin/BOMBOV.8xv
fasmg example/file/BomboFFXII1.inc bin/BOMBOF.8xv

Rem tools/mdlconv.exe example/file/UltimaFFXII.obj -T -N -S -B -X -o=ULTIMA
Rem fasmg example/file/UltimaFFXII0.inc bin/ULTIMAV.8xv 
Rem fasmg example/file/UltimaFFXII1.inc bin/ULTIMAF.8xv 

echo "Converting FFX test models..."

tools/mdlconv.exe example/file/LuluFFX.obj -T -N -S -B -X -F -o=LULU
...
tools/mdlconv.exe example/file/TonberryFFVIII.obj -T -N -S -B -X -F -o=TONB
fasmg example/file/TonberryFFVIII0.inc bin/TONBV.8xv 
fasmg example/file/TonberryFFVIII1.inc bin/TONBF.8xv 

tools/mdlconv.exe example/file/UltimeciaFFVIII.obj -T -N -S -B -X -F -o=ULTIM
...
tools/mdlconv.exe example/file/MidnaZelda.obj -T -N -S -B -X -F -o=MIDNA
...
tools/mdlconv.exe example/file/NabooruZelda.obj -T -N -S -B -X -F -o=NABOORU
fasmg example/file/NabooruZelda0.inc bin/NABOORUV.8xv 
fasmg example/file/NabooruZelda1.inc bin/NABOORUF.8xv 

Rem echo "Converting animation file"
Rem ./tools/xmlconv example/file/FILE.xml
Rem fasmg example/file/XML0.ez80 bin/LARAV.8xv 
Rem fasmg example/file/XML1.ez80 bin/LARAF.8xv 

echo "Converting CavesOfKaliyaTRIII.png"
tools/texconv.exe -compress -o=KALIYAT example/file/CavesOfKaliyaTRIII.png #-dithering

echo "Converting CityTRIII.png"
tools/texconv.exe -dithering -compress -o=CITYT example/file/CityTRIII.png

echo "Converting TrainRoomTRIII.png"
tools/texconv.exe -dithering -compress -o=TRAINT example/file/TrainRoomTRIII.png

echo "Converting PoolTRIII.png"
tools/texconv.exe -alpha -dithering -compress -o=POOLT example/file/PoolTRIII.png

echo "Converting LaraTRIII.png"
tools/texconv.exe -dithering -compress -o=LARAT example/file/LaraTRIII.png

echo "Converting texture.png"
tools/texconv.exe -dithering -compress -o=ROOMT example/file/texture.png

echo "Converting FranFFXII.png"
tools/texconv.exe -alpha -compress -o=FRANT example/file/FranFFXII.png

echo "Converting MjrnFFXII.png"
tools/texconv.exe -alpha -dithering -compress -o=MJRNT example/file/MjrnFFXII.png

echo "Converting BunnyFFXII.png"
tools/texconv.exe -alpha -dithering -compress -o=FLUFFYT example/file/BunnyFFXII.png

echo "Converting MateusFFXII.png"
tools/texconv.exe -dithering -compress -o=MATEUST example/file/MateusFFXII.png

echo "Converting VieraSceneFFXII.png"
tools/texconv.exe -dithering -compress -o=VIERAT example/file/VieraSceneFFXII.png

echo "Converting LuluFFX.png"
tools/texconv.exe -dithering -compress -o=LULUT example/file/LuluFFX.png

echo "Converting TonberryFFVIII.png"
tools/texconv.exe -dithering -compress -o=TONBT example/file/TonberryFFVIII.png

echo "Converting UltimeciaFFVIII.png"
tools/texconv.exe -dithering -compress -o=ULTIMT example/file/UltimeciaFFVIII.png

echo "Converting MidnaZelda.png"
tools/texconv.exe -dithering -compress -o=MIDNAT example/file/MidnaZelda.png

echo "Converting NabooruZelda.png"
tools/texconv.exe -dithering -compress -o=NABOORUT example/file/NabooruZelda.png

echo "Converting Background.png"
tools/texconv.exe -dithering -o=SKYBOX0 example/file/Background.png

echo "Converting BackgroundJungle.png"
tools/texconv.exe -dithering -o=SKYBOX1 example/file/BackgroundJungle.png

echo "Converting BackgroundPacific.png"
tools/texconv.exe -dithering -o=SKYBOX2 example/file/BackgroundPacific.png

echo "Converting BackgroundNevada.png"
tools/texconv.exe -dithering -o=SKYBOX3 example/file/BackgroundNevada.png

echo "Converting BackgroundLondon.png"
tools/texconv.exe -dithering -o=SKYBOX4 example/file/BackgroundLondon.png

echo "Converting BomboFFXII.png"
tools/texconv.exe -alpha -dithering -compress -o=BOMBOT example/file/BomboFFXII.png

echo "Converting UltimaFFXII.png"
tools/texconv.exe -dithering -compress -o=ULTIMAT example/file/UltimaFFXII.png
